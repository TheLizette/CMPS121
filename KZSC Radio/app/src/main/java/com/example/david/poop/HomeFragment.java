...
public class HomeFragment extends Fragment {
    ...
    private class RetrieveFeedTask extends AsyncTask {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            String url = "";
            String time = "";
            Elements playingElements = doc.getElementsByClass("nowplaying");
            Elements elements = doc.getElementsByClass("nfo");
            Elements imageElements = doc.getElementsByClass("art");

//            for (Element element : playingElements) {
//                currentlyPlaying = element.select("a").text();
//                Log.d("CURR", currentlyPlaying);
//            }
...
//                Log.d("URL:", srcValue);
            ...
            for (Element element : elements) {
                ...
                Elements els3 = element.getElementsByClass("st");//                Elements els3 = element.select("img");
//                element.select("img").absUrl("src");
//                String absoluteUrl = imageElement.absUrl("src");  //absolute URL on src
//                String srcValue = imageElement.attr("src");  // exact content value of the attribute.
//                Log.d("URL:", srcValue);
            ...
            getActivity().runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    ListAdapter listAd = new CustomAdapter2(getActivity(), artists);
    ...
    public View onCreateView (LayoutInflater inflater, @Nullable ViewGroup
        ...
        TextView lol = (TextView) rootView.findViewById(R.id.listLabel);
        lol.setPaintFlags(lol.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
