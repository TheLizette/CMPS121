...
class CustomAdapter2 extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (getContext() != null) {
            ...
            TextView timeOfSong = (TextView) customView.findViewById(R.id.timeView);
            timeOfSong.setText(json.get("time").toString());
            artistName.setText("Artist: " + json.get("artist").toString());
            songName.setText("Song: " + json.get("song").toString());
